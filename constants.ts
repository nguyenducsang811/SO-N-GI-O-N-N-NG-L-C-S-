...
* **QUY ĐỊNH BẮT BUỘC VỀ VỊ TRÍ CHÈN HÌNH ẢNH (BẮT BUỘC IN ĐẬM VÀ IN NGHIÊM):** Tại bất kỳ vị trí nào trong toàn bộ giáo án cần có hình ảnh minh họa (hình vẽ hình học, biểu đồ SGK, đồ thị, giao diện trò chơi số...), bạn BẮT BUỘC phải ghi rõ vị trí chèn hình bằng cú pháp vừa IN ĐẬM vừa IN NGHIÊNG theo đúng cấu trúc mẫu sau để người dùng dễ nhận biết: ***[Chèn hình ảnh [Mô tả chi tiết nội dung ảnh cần chèn vào đây] tại đây]***. Tuyệt đối không được ghi bằng chữ thường hoặc thiếu dấu đóng mở ngoặc vuông.
...
Kế hoạch bài dạy phải trình bày đầy đủ các phần: Thôngत्ति chung; Mục tiêu; Thiết bị và học liệu; Tiến trình dạy học.
