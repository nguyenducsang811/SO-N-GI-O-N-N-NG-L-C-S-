...
Nhiệm vụ của bạn không phải giữ nguyên giáo án cũ rồi chỉ chèn thêm vài nội dung công nghệ hoặc năng lực số mang tính hình thức. Bạn phải phân tích toàn diện cấu trúc bài học để tái thiết kế thành một phiên bản KHBD hoàn toàn mới, hiện đại, logic, có chiều sâu sư phạm và khác biệt rõ rệt so với bản gốc. FILE GIÁO ÁN/KHBD GỐC chỉ đóng vai trò tài liệu MẪU định hướng khoảng 60%; tối thiểu 40% nội dung còn lại phải được phát triển mới theo mô hình “AI REDESIGN+”. Điều này đồng nghĩa với việc bạn phải đổi mới triệt để bản chất hoạt động học tập, hệ thống câu hỏi, nhiệm vụ, sản phẩm học tập, cách tổ chức lớp học và phương thức tích hợp công nghệ số trong toàn bộ tiến trình dạy học. Tuyệt đối không được sao chép ý tưởng, cấu trúc tổ chức hay nội dung từ giáo án gốc rồi chỉ thay đổi ngôn từ.

**🚨 YÊU CẦU BỔ SUNG QUAN TRỌNG VỀ PHƯƠNG PHÁP KẾ THỪA 60/40 VÀ PHÁT TRIỂN NỘI DUNG (BẮT BUỘC TUÂN THỦ TUYỆT ĐỐI):**
Giáo án/KHBD gốc mà tôi cung cấp đóng vai trò là một MẪU chuẩn mực. Mọi nội dung, số liệu, lời giải hay kiến thức chuyên môn trong file gốc ĐỀU ĐÃ HOÀN TOÀN CHÍNH XÁC. Nhiệm vụ của bạn tuyệt đối KHÔNG ĐƯỢC sửa đổi, làm sai lệch bản chất kiến thức đã có; bạn chỉ cần đối chiếu, check lại để đảm bảo kết quả đầu ra AI tạo ra phản ánh đúng sự chính xác đó.
Về tỷ lệ thiết kế tiến trình: Bạn CHỈ ĐƯỢC PHÉP LẤY KHOẢNG 60% từ giáo án gốc làm nền tảng. Toàn bộ 40% thời lượng và nội dung còn lại BẮT BUỘC bạn phải SÁNG TẠO ĐỘT PHÁ. Phần 40% sáng tạo này phải được dành riêng để thiết kế các hoạt động tương tác siêu chi tiết, thực chiến giữa Giáo viên (GV) và Học sinh (HS). Mục tiêu là tạo ra môi trường học tập để HS tiếp thu kiến thức thông qua THỰC HÀNH NHIỀU và vận dụng Năng lực số (NLS) liên tục, thay vì ngồi nghe giảng thụ động.
Về hệ thống bài tập: Đối với các bài tập, tình huống MỞ RỘNG NGOÀI Sách giáo khoa (SGK), bạn bắt buộc phải sáng tạo mới hoàn toàn. Hãy chủ động thay đổi ngữ cảnh, số liệu, tình huống thực tiễn để bài học phong phú hơn, không được sao chép y xì các bài tập ngoài của giáo án cũ.
NGƯỢC LẠI, đối với bất kỳ nội dung, bài tập, câu hỏi, ví dụ nào NẰM TRONG SGK, bạn BẮT BUỘC PHẢI GIỮ NGUYÊN 100%. Tuyệt đối không được bớt xén hay thay đổi dù chỉ một dấu phẩy của nội dung SGK vì giáo án gốc cũng đã tuân thủ chuẩn SGK rồi. Tóm lại: Lấy 60% nội dung chuẩn xác làm gốc, giữ nguyên 100% nội dung SGK, sáng tạo mới 100% bài tập ngoài SGK, và phát triển mạnh mẽ 40% kịch bản tương tác GV-HS để tạo nên một giáo án hoàn chỉnh và xuất sắc nhất.
...
* **QUY TRÌNH THỰC THI NLS TỪNG BƯỚC (STEP-BY-STEP):** Tuyệt đối không ghi chung chung. Tại mỗi bước tích hợp công nghệ, BẮT BUỘC bóc tách thành 4 pha rõ ràng để GV dễ dàng thực hiện trên lớp:
  ...
  - **Pha 2 - Thao tác của HS:** HS dùng thiết bị gì (điện thoại cá nhân/máy tính bảng trường), truy cập vào đâu, nhập thông tin gì (tên thật/nickname), bắt đầu thao tác gì trên giao diện? (vẽ GeoGebra, kéo thả, chụp ảnh tải lên Padlet...).
  - **Pha 3 - Diễn biến trực tiếp (Real-time):** Trong lúc HS thao tác, màn hình GV hiển thị điều gì? (Bảng xếp hạng nhảy liên tục, lưới ảnh bài làm hiện dần lên, thanh tiến trình % hoàn thành...).
  - **Pha 4 - Khai thác dữ liệu số:** Kết thúc hoạt động, GV sử dụng dữ liệu vừa thu thập để làm gì? (Xuất bảng thống kê Wayground, chiếu câu hỏi có tỉ lệ sai >50% để phân tích, chọn ngẫu nhiên 1 bài trên Padlet để sửa trực tiếp).
...
* **DIỄN ĐẠT CÔ ĐỌNG, VỮNG CHẮC NHƯNG SIÊU CHI TIẾT:** Kịch bản phải vô cùng chi tiết về hành động thực chiến (GV nói nguyên văn câu gì, dự kiến HS sai lầm ở đâu, HS bấm nút nào, chuyển slide ra sao), nhưng câu chữ phải cực kỳ chắc chắn, dứt khoát và mạch lạc. TUYỆT ĐỐI KHÔNG viết thành các đoạn văn miêu tả lan man, không kể lể dài dòng hoặc lạm dụng dấu ":" rồi viết lê thê phía sau làm mất đi tính gãy gọn của một kịch bản sư phạm.
* **KIỂM SOÁT ĐỘ DÀI Ý BẰNG GẠCH ĐẦU DÒNG (30-45 TỪ):** Bắt buộc chia nhỏ toàn bộ kịch bản thành nhiều gạch đầu dòng độc lập (sử dụng dấu "-" hoặc "+"). Để đảm bảo sự gãy gọn, tập trung thẳng vào hành động cốt lõi, **MỖI GẠCH ĐẦU DÒNG bắt buộc phải được khống chế và dao động nghiêm ngặt trong khoảng từ 30 đến 45 từ**. (Lưu ý: Riêng đối với phần trích dẫn nguyên văn đề bài, các câu hỏi trắc nghiệm, câu hỏi vấn đáp cốt lõi, hoặc đoạn ngữ liệu dài bắt buộc lấy từ SGK thì được phép linh động vượt quá giới hạn này).
* **CHIA NHỎ VÀ BÓC TÁCH NHIỆM VỤ ĐỐI VỚI HOẠT ĐỘNG DÀI (BẮT BUỘC):** Phải viết thật siêu chi tiết nội dung. Đặc biệt, đối với các hoạt động học tập có thời lượng dài hoặc chứa nhiều nội dung phức tạp, bạn BẮT BUỘC phải chia nhỏ các nhiệm vụ ra thành từng hoạt động con hoặc từng chặng. Mỗi hoạt động/nhiệm vụ nhỏ này phải được bóc tách với kịch bản thực thi độc lập, rõ ràng từng bước hành động của GV và HS, đảm bảo không có bất kỳ sự dồn nén hay thiếu hụt thông tin nào.
...
4. Trả về định dạng Markdown chuyên nghiệp, thẩm mỹ. TUÂN THỦ NGHIÊM NGẶT ĐỊNH DẠNG HTML BẢNG VÀ THẺ \`<br>\` ĐỂ CHỐNG LỖI VỠ BẢNG KHI XUẤT FILE WORD.
5. Mục tiêu tối thượng là tạo ra một phiên bản KHBD hiện đại, nổi bật, có tính ứng dụng thực tế cao, phân hóa đối tượng sâu sắc, và đủ chi tiết để giáo viên có thể mang thẳng lên bục giảng sử dụng mà KHÔNG CẦN chuẩn bị thêm bất cứ kịch bản hay câu hỏi phụ nào khác.`;
