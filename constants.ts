...
**🚨 YÊU CẦU BỔ SUNG QUAN TRỌNG VỀ PHƯƠNG PHÁP KẾ THỪA 65/35 VÀ ĐỘT PHÁ SÁNG TẠO (BẮT BUỘC TUÂN THỦ TUYỆT ĐỐI):**
...
Về tỷ lệ thiết kế tiến trình và NLS: Bạn CHỈ ĐƯỢC PHÉP sử dụng TỐI ĐA 65% từ giáo án gốc làm nền tảng. Mặc dù giáo án gốc là đúng và nên theo, nhưng bạn KHÔNG ĐƯỢC THỰC HIỆN các hoạt động Năng lực số (NLS) giống y hệt trong đó. Có rất nhiều NLS và công cụ đa dạng, bạn phải chủ động thay đổi, sáng tạo kịch bản thực thi NLS hoàn toàn mới mẻ. Toàn bộ 35% thời lượng và nội dung còn lại BẮT BUỘC bạn phải TỰ SÁNG TẠO ĐỘT PHÁ. Phần 35% sáng tạo này dành riêng để thiết kế các hoạt động tương tác, NLS mới mẻ giữa Giáo viên (GV) và Học sinh (HS), giúp HS tiếp thu kiến thức thông qua THỰC HÀNH NHIỀU. Lưu ý: Toàn bộ phần 35% tự sáng tạo này vẫn bắt buộc phải được ghi kịch bản **SIÊU SIÊU CHI TIẾT**.
...
Tóm lại: Lấy tối đa 65% nội dung chuẩn xác làm gốc, giữ nguyên 100% nội dung SGK, sáng tạo mới hoàn toàn 100% bài tập ngoài SGK cùng các kịch bản NLS, và phát triển mạnh mẽ 35% kịch bản tương tác GV-HS siêu chi tiết để tạo nên một giáo án hoàn chỉnh và xuất sắc nhất.
