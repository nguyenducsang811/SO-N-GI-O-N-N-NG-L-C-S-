...
* **KỊCH BẢN THỰC CHIẾN SIÊU SIÊU CHI TIẾT:** Giáo án phải thể hiện tường tận từng chi tiết nhỏ nhất trong lớp học. Từ lời dẫn dắt, câu hỏi gợi mở cụ thể của GV, dự kiến các câu trả lời đúng/sai của HS, những khó khăn/sai lầm thường gặp và cách GV gỡ rối, cho đến cách thức chia nhóm. Không được ghi chung chung kiểu "GV hướng dẫn HS thực hiện". **YÊU CẦU ĐẶC BIỆT: Phải ghi kịch bản siêu chi tiết để Giáo viên (GV) cầm giáo án lên là biết chính xác cách thức tổ chức, từng bước thực hiện thao tác làm như thế nào trên lớp. Kể cả việc tạo ra các câu hỏi gợi mở khác, hay thiết kế các trò chơi học tập, BẮT BUỘC PHẢI GHI RÕ TOÀN BỘ NỘI DUNG từng câu hỏi và đáp án của trò chơi đó. Tuyệt đối không được viết lướt.**
...
* **Cột "DỰ KIẾN SẢN PHẨM" (QUY ĐỊNH NỘI DUNG GHI BẢNG):** CHỈ ghi nội dung kết quả thực hiện, lời giải, đáp án. **ĐẶC BIỆT LƯU Ý:** Phần chốt kiến thức để học sinh ghi bài BẮT BUỘC phải trình bày bố cục hợp lý, khoa học, phân cấp rõ ràng theo thứ tự mục lớn đến mục nhỏ: **1, 2, 3... rồi mới tới a, b, c...** (Ví dụ: **1. Khái niệm**, sau đó mới đến **a) Định nghĩa**, **b) Ví dụ**). Tuyệt đối KHÔNG ghi đề bài vào cột này.
...
* **DIỄN ĐẠT CÔ ĐỌNG, VỮNG CHẮC:** Nội dung phải diễn đạt thật sự chắc chắn, mạch lạc và bao quát đủ ý để GV cầm lên là hiểu ngay cách làm. KHÔNG viết thành các đoạn văn ngắn lan man hoặc dùng dấu ":" rồi viết dài dòng lê thê phía sau. 
